...
public class Definition
{
    ...
    public MacroString assignment = new();
...
{
    public MacroString question = new();
    public ResultType resultType = new();
    public ResultMethod result = new();
    public List<MacroString> solutionSteps = new();
    public List<string> imagePaths = new();
}
...
abstract public class Method
{
    ...
    // Zabalit cod a comenty do jedne struktury, aby bylo jasne ze patri k sobe.
